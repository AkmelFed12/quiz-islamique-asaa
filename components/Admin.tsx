...
import { Power, Settings, Clock, Loader2, Database, Upload, Trash2, Edit2, Plus, Save, X, Mail, Users, LayoutDashboard, Search, Filter, Shield, ShieldAlert, Download, Sparkles } from 'lucide-react';
import { AdminQuestions } from './AdminQuestions';

export const Admin: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'DASHBOARD' | 'USERS' | 'QUESTIONS' | 'AI_GENERATOR' | 'CONFIG'>('DASHBOARD');
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {/* Nav */}
      <div className="grid grid-cols-2 md:grid-cols-5 gap-2 md:gap-4 bg-gray-100 p-2 rounded-2xl">
          ...
          <TabButton id="AI_GENERATOR" label="Générateur IA" icon={Sparkles} />
